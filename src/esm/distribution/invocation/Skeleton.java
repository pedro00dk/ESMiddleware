...
public abstract class Skeleton {
    ...
    public final MethodResult processRemoteInvocation(MethodInvocation methodInvocation) {
        ...
        Tuple<Object, Class> result = null;
        Throwable throwable = null;
        try {
            Method method = getClass()
                    .getDeclaredMethod(methodInvocation.getMethodName(), methodArgumentTypes);
            result = new Tuple<>(method.invoke(this, methodArguments), method.getReturnType());
        ...
        if (methodInvocation.isExpectResult()) {
            return new MethodResult(methodInvocation.getMethodName(), result, throwable);
        } else {
            return null;
        }
    }
